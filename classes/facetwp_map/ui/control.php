 ...
 * @since       1.0.0
 */
class control extends \facetwp_map\data\data {
    ...
    public function render() {
        ...
        $output = '<div id="' . esc_attr( $this->id() ) . '" class="facetwp_map-control facetwp_map-control-' . esc_attr( $this->type ) . ' ' . esc_attr( $this->id() ) . '">';

        $output .= $this->label();
        $output .= '<div class="facetwp_map-control-input">';
        $output .= $this->input();
        $output .= '</div>';
    ...
    public function label() {
        ...
        if ( isset( $this->struct['label'] ) ) {
            $output .= '<label for="' . esc_attr( $this->id() ) . '-control"><span class="facetwp_map-control-label">' . esc_html( $this->struct['label'] ) . '</span></label>';
        }
