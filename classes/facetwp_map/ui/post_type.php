...
/**
 * FWP_MAP Post Type class for adding custom post types
 * @package facetwp_map\ui
 * @author  David Cramer
 */
class post_type extends facetwp_map {
	...
	/**
	 * Define core FWP_MAP styling to identify FWP_MAP post types
	 *
	 * @since 1.0.0
	 * @access public
	 */
	public function set_assets() {
		$this->assets['style']['post'] = $this->url . 'assets/css/post' . FWP_MAP_ASSET_DEBUG . '.css';
		parent::set_assets();
	}
