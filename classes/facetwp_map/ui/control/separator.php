 ...
 * @since 1.0.0
 */
class separator extends \facetwp_map\ui\control {
	...
	public function input() {
		...
		return '<hr class="facetwp_map-separator" id="control-' . esc_attr( $this->id() ) . '" />';
	...
	protected function set_active_styles() {
		...
		$style .= '#' . $this->id() . ' span.facetwp_map-control-label {color: ' . $this->base_color() . ';}';
