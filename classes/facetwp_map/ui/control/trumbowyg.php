 ...
 * @since 1.0.0
 */
class trumbowyg extends \facetwp_map\ui\control\textarea {
	...
	public function set_assets() {
		...
		$this->assets['style']['trumbowyg']       = $this->url . 'assets/controls/trumbowyg/ui/trumbowyg' . FWP_MAP_ASSET_DEBUG . '.css';
		$this->assets['script']['trumbowyg'] = array(
			'src'  => $this->url . 'assets/controls/trumbowyg/trumbowyg' . FWP_MAP_ASSET_DEBUG . '.js',
			'deps' => array( 'jquery' ),
		);
		$this->assets['script']['trumbowyg-init'] = array(
			'src'  => $this->url . 'assets/controls/trumbowyg/trumbowyg-init' . FWP_MAP_ASSET_DEBUG . '.js',
