...
class ui{
    ...
    public function auto_load() {
         ...
         */
        do_action( 'facetwp_map_register', $this );
    ...
    public function get_register_callback( $type ) {
        $init = array( '\facetwp_map\ui\\' . $type, 'register' );
        if ( ! is_callable( $init ) ) {
            return null;
        }
    ...
    /**
     * Register the FWP_MAP object paths for autoloading
     *
     * @since 1.0.0
     *
