...
abstract class facetwp {
	 ...
	 * @param facetwp $parent Parent fwp_map Object
	 */
	...
	/**
	 * Define core fwp_map styles - override to register core ( common styles for facetwp type )
	 *
	 * @since 1.0.0
	 * @access public
	 */
	 ...
	 *
	 * @return object|\facetwp object instance
	 */
	...
	protected function core_assets() {
		wp_register_script( 'facetwp', $this->url . 'assets/js/core' . fwp_map_ASSET_DEBUG . '.js' );
		wp_register_style( 'facetwp', $this->url . 'assets/css/core' . fwp_map_ASSET_DEBUG . '.css', array( 'dashicons' ) );
		wp_localize_script( 'facetwp', 'facetwpApi', array( 'root' => esc_url_raw( rest_url() ), 'nonce' => wp_create_nonce( 'wp_rest' ) ) );
	...
	public function enqueue_core() {
		...
		// register facetwp core asset
		$this->core_assets();

		/**
		 * do object initilisation
		 *
		 * @param object current facetwp instance
		 */
