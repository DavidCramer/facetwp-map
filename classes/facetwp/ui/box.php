 ...
 * @author  David Cramer
 */
class box extends panel implements \facetwp\data\save, \facetwp\data\load {
	...
	public function set_attributes() {
		...
		$attributes = array(
			...
			'method'   => 'POST',
			'class'    => 'facetwp-ajax facetwp-' . $this->type,
			'data-facetwp' => $this->slug,
			'action'   => $action['REQUEST_URI'],
		);
		if ( ! empty( $this->struct['static'] ) ) {

			$attributes = array(
				'class'    => 'facetwp-' . $this->type,
				'data-facetwp' => $this->slug,
			);
		}
