...
class metabox extends panel {
	...
	protected function set_active_styles() {
		...
		$style = '#' . $this->id() . '.facetwp-top-tabs > .facetwp-panel-tabs > li[aria-selected="true"] a,';
		$style .= '#side-sortables #' . $this->id() . ' > .facetwp-panel-tabs > li[aria-selected="true"] a {';
		$style .= 'box-shadow: 0 3px 0 ' . $this->base_color() . ' inset; }';

		$style .= '#' . $this->id() . ' > .facetwp-panel-tabs > li[aria-selected="true"] a {';
