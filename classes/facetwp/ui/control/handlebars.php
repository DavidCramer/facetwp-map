 ...
 * @since 1.0.0
 */
class handlebars extends \facetwp\ui\control {
	...
	public function set_data( $data ) {
		if ( isset( $data[ $this->slug ] ) ) {
			...
			$this->data[ $this->id() ][ $this->slug ] = apply_filters( 'facetwp_' . $this->slug . '_sanitize_' . $this->type, $data[ $this->slug ], $this );
		}
	...
	public function render() {
		...
		$output = '<div class="facetwp-tab-canvas" data-app="' . esc_attr( $this->name() ) . '" ' . esc_attr( $this->build_attributes() ) . '></div>';
